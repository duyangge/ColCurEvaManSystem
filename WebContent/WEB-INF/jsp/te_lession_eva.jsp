...
<body>
		<div class="wrap-container clearfix">
				...
				<!-- form表单，将搜索按钮变为提交按按钮 -->
					<form class="layui-form" action="../classSub/findStudentClassSubByTeacher.do" method="post">
					...
					<table class="layui-table" lay-even lay-skin="nob">
							...
							<c:forEach items="${lesEvaList}" var="lesEva" varStatus="status">
									...
									<td >
										<div class="layui-inline">
											<button class="layui-btn layui-btn-mini layui-btn-normal tea_see_eva_edit-btn" data-id="${lesEva.id }" data-url="../classSub/goTeacherSeeLessionEva.do"><i class="layui-icon">&#xe642;</i></button>
										</div>
									</td>
								</tr>
							</c:forEach>
...
<script type="text/javascript">
	...
	function firstPage(){
		...
		window.location.href="../classSub/findStudentClassSubByTeacher.do?currentPage=1&keyWords="+name+"&pageSize="+pageSize+"&startTime="+startTime+"&endTime="+endTime;
	}
	function finalPage(){
		var name = document.getElementById("seacher").value;
		window.location.href="../classSub/findStudentClassSubByTeacher.do?currentPage="+${totalPage }+"&keyWords="+name+"&pageSize="+pageSize+"&startTime="+startTime+"&endTime="+endTime;
	}
	function nextPage(){
		var name = document.getElementById("seacher").value;
		window.location.href="../classSub/findStudentClassSubByTeacher.do?currentPage="+${currentPage + 1 }+"&keyWords="+name+"&pageSize="+pageSize+"&startTime="+startTime+"&endTime="+endTime;
	}
	...
	function goDis(){
		...
		window.location.href="../classSub/findStudentClassSubByTeacher.do?&keyWords="+name+"&pageSize="+pageSize+"&currentPage="+currentPage+"&startTime="+startTime+"&endTime="+endTime;
	}
</script>		
</html>