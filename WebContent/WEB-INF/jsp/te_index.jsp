				...
				<ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
					<c:forEach items="${funList }" var="fun" varStatus="status">
					      <li class="layui-nav-item">
						    ...
						    <c:if test="${  not empty fun.subFunInfoList[0].funId   }">
					...
					<!--主体标题  -->
					  ...
					  <div class="layui-tab-content">
					    <div class="layui-tab-item layui-show" style="background: #f5f5f5;">
					    	<!--1-->
					    	<iframe src="../user/indexTeacher.do" width="100%" height="100%" name="iframe" scrolling="auto" class="iframe" framborder="0" ></iframe>
					    	<!--1end-->
					    </div>
					  </div>
