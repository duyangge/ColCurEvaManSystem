...
<div class="main-layout" id='main-layout'>
			...
			<div class="main-layout-side">
				<div class="m-logo">
					<div align="center">
					 	 <img  alt="" src="/pic/${student.headImage }"   height="60px" width="60px;"  style="border-radius: 250px;">
					  </div>
				</div>
					...
					<!--主体标题  -->
					  ...
					  <div class="layui-tab-content">
					    <div class="layui-tab-item layui-show" style="background: #f5f5f5;">
					    	<!--1-->
					    	<iframe src="../user/indexStudent.do" width="100%" height="100%" name="iframe" scrolling="auto" class="iframe" framborder="0" ></iframe>
					    	<!--1end-->
					    </div>
					  </div>		  
					</div>
