...
<meta name="renderer" content="webkit">
	...
	<body>
		<div class="wrap-container">
			<form class="layui-form" style="width: 90%;padding-top: 20px;" action="../classSub/updateLessionEva.do" method="post">
				
					<div class="layui-form-item">
						<label class="layui-form-label">班级名称：</label>
						<div class="layui-input-block">
						    <input type="hidden" value="${lesTemp.id }" name="subEvaId">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="radio" name="subStatus" value="0" title="可见" <c:if test="${lesTemp.status eq '0' }">checked="checked"</c:if>/>
							<input type="radio" name="subStatus" value="1" title="不可见" <c:if test="${lesTemp.status eq '1' }">checked="checked"</c:if>/>
						</div>
					</div>
					
					<div class="layui-form-item">
						<div class="layui-input-block">
							<button class="layui-btn layui-btn-normal" onclick="javaScript:history.go(-1);" >立即提交</button>
						</div>
					</div>
				</form>
		</div>
