...
<script src="../js/common.js" type="text/javascript" charset="utf-8"></script>
	<body>
		<div class="wrap-container clearfix">
				...
				<!-- form表单，将搜索按钮变为提交按按钮 -->
					<form class="layui-form" action="../lession/findLessionByClass.do" method="post">
	...
	function firstPage(){
		...
		window.location.href="../lession/findLessionByClass.do?currentPage=1&keyWords="+name+"&pageSize="+pageSize;
	}
	function finalPage(){
		var name = document.getElementById("seacher").value;
		window.location.href="../lession/findLessionByClass.do?currentPage="+${totalPage }+"&keyWords="+name+"&pageSize="+pageSize;
	}
	function nextPage(){
		var name = document.getElementById("seacher").value;
		window.location.href="../lession/findLessionByClass.do?currentPage="+${currentPage + 1 }+"&keyWords="+name+"&pageSize="+pageSize;
	}
	...
	function goDis(){
		...
		window.location.href="../lession/findLessionByClass.do?&keyWords="+name+"&pageSize="+pageSize+"&currentPage="+currentPage;
	}
</script>		
</html>